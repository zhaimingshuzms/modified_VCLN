...
class general_GCN_layer(torch.nn.Module):
    def __init__(self):
...
class snowball_layer(general_GCN_layer):
    def __init__(self, in_features, out_features):
        ...
        self.weight, self.bias = torch.nn.Parameter(torch.FloatTensor(self.in_features, self.out_features).cuda()), torch.nn.Parameter(torch.FloatTensor(self.out_features).cuda())
        self.reset_parameters()
