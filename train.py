...
from models import modified_GVCLN_snowball,GVCLN
import warnings
...
parser.add_argument('--use_GVCLN', type=bool, default=False, help='Whether to use GVCLN or not')
...
def Graph_pseudo(adj, features, labels, idx_train, idx_val, idx_test):
	...
	if args.use_GVCLN:
		...
		print("use modified_GVCLN_snowball")
		model = modified_GVCLN_snowball(nfeat=features.shape[1], nlayers_1=args.layers, activation_1=torch.tanh,\
				  nclass_1=labels.max().item() + 1, nhid_1=args.hidden_1, \
				  dropout_1=args.dropout_1, nhid_2=args.hidden_2, dropout_2=args.dropout_2, alpha_2=args.alpha_2, \
				  nheads_2=args.nb_heads_2)
